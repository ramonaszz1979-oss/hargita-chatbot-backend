...
3. A **Disszertáció** fülön a **Disszertációs dolgozat segéd** panelben három előre beállított témát választhatsz (technikai leírás, működési elv, megvalósítási folyamat), vagy saját kérdést írhatsz be, majd a **Segédlet kérése** gombbal küldheted a kérést a chatbe.
...
9. Az **Általános** fülön a **Beágyazási kód megnyitása** gomb egy stílust és úszó iframe-et tartalmazó másolható kódot mutat, amit a láblécbe vagy globális HTML blokkba illesztve minden oldalon megjelenítheted a chatbotot.
